...
if (StarBeast2_TF == FALSE)
	...
	if (startingTree_option == "construct")
		{
	...
	xml = make_BDSKY_model(treemodel_df, tree_name=tree_name, clockModel_name=clockModel_name, alignment_name_w_taxa=alignment_name_w_taxa, tipDates_id="tipDates", xml=xml, XML_mod_for_cont_chars=XML_mod_for_cont_chars, trstr=trstr)
