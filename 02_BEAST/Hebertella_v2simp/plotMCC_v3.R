...
# wd = "/drives/GDrive/__GDrive_projects/2016-09-01_Adrian_Lam_Stigall/02_BEAST/Hebertella_v2simp/"
# setwd(wd)
...
titletxt = "Hebertella_v2; Beast2 w. BEASTmasteR"
...
minage=441.84	            # Should the right edge of the plot be 0 mya or some other value?
