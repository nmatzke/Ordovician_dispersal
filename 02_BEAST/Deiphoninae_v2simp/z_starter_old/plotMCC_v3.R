...
titletxt = "Deiphoninae_v2; BEASTmasteR setup w. Beast2"
...
minage=443.4	            # Should the right edge of the plot be 0 mya or some other value?
...
logfn = "traceLog3.txt"    # Filename of the Beast2 log file
