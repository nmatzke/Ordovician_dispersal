...
wd = "/drives/GDrive/__GDrive_projects/2016-09-01_Adrian_Lam_Stigall/02_BEAST/Deiphoninae_v2simp/"
setwd(wd)
...
titletxt = "Deiphoninae_v2; Beast2 setup w. BEASTmasteR"
...
minage=424.9	            # Should the right edge of the plot be 0 mya or some other value?
