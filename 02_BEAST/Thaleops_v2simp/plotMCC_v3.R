...
# wd = "/drives/GDrive/__GDrive_projects/2016-09-01_Adrian_Lam_Stigall/02_BEAST/Thaleops_v2simp/"
# setwd(wd)
...
titletxt = "Thaleops_v2simp; BEASTmasteR setup w. Beast2"
...
minage=446.81	            # Should the right edge of the plot be 0 mya or some other value?
