...
# wd = "/drives/GDrive/__GDrive_projects/2016-09-01_Adrian_Lam_Stigall/02_BEAST/Flexicalymene_v2simp/"
# setwd(wd)
...
titletxt = "Flexicalymene_v2; BEASTmasteR setup w. Beast2"
...
minage=438.5	            # Should the right edge of the plot be 0 mya or some other value?
...
burnin_skipnum=1900        # Number of trees to skip as burnin
