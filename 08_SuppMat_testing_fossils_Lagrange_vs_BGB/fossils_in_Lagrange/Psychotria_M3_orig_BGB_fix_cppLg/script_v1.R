...
wd = "/drives/GDrive/__GDrive_projects/2016-02-04_Reddy_Condamine/DECX_biorXiv/Appendix_7_Fossil_tips_Palpimanoids/fossils_in_Lagrange/Psychotria_M3_orig_BGB_fix_cppLg/"
setwd(wd)
...
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["d","init"] = 0.0342543
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["d","est"] = 0.0342543
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["d","min"] = 0.0342540
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["d","max"] = 0.0342545

BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["e","init"] = 1.15E-07
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["e","est"] = 1.15E-07
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["e","min"] = 1.00E-07
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["e","max"] = 1.30E-07
